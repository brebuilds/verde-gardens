...
export const Gallery = () => {
  ...
  return <section id="gallery" className="verde-section">
      <div className="verde-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryItems.map((item, index) => <div key={index} className={`verde-gallery-item group ${item.large ? "md:col-span-2 lg:col-span-2" : ""} ${item.large ? "h-80 lg:h-96" : "h-64"}`}>
